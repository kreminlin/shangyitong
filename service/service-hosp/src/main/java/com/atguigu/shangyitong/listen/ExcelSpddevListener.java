...
@Slf4j
public class ExcelSpddevListener extends AnalysisEventListener<Object> {

    //private UserService userService;
    private File file;
    String sheetName = "原始测点";

    public ExcelSpddevListener(File file) {
        this.file = file;
    }
...
//        log.info("解析到一条数据:{}", data);
    ...
    private void saveData() throws IOException {
        ...
        if (!CollectionUtils.isEmpty(list)) {
            ...
            ExcelUtils.noModelWrite("F:\\桌面\\exportFiles\\" + fileName + "_spddev.xls", sheetName, list, OriginalPointDTO.class);
        }
        log.info("存储数据库成功！");
    }
